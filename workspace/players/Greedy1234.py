...
class Greedy(Player):
    ...
    def preprocessing(self, maze: Maze, game_state: GameState) -> None:
        ...
        self.cheese_locations = game_state.cheese
        self.actions = []
        print("cheese_locations", self.cheese_locations)
    ...
    def turn(self, maze: Maze, game_state: GameState) -> Action:
        ...
        if not self.actions:
            ...
            cheeses = game_state.cheese  # Liste dynamique des fromages restants
            print("fro", cheeses)
            if cheeses:
