...
class Exh(Player):
    ...
    def __init__ ( self:     Self,
        ...
        """
            ...
            This is where you should define the attributes of the object and
            set their initial values.
            Arguments *args and **kwargs are used to pass arguments to the parent
            constructor.
    ...
    def preprocessing ( self:       Self,
        ...
        """
            ...
            In:
                * self:       Reference to the current object.
                * maze:       An object representing the maze in which the player
                plays.
    ...
    def turn ( self:       Self,
        ...
        """
            ...
            It returns an action to perform among the possible actions, defined
